...
import {DataState, ApplicationState, MonthOverview, DayWithAppointments, Appointment} from "./shared/stateTypes";
import {SET_SELECTEDDAY, SET_SELECTEDWEEK, SET_SELECTEDMONTH, ADD_APPOINTMENT, UPDATE_APPOINTMENT, REMOVE_APPOINTMENT, SET_VIEWMODE} from "./shared/actions";
